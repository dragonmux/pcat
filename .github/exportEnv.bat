...
echo ::set-env name=PATH::%HOMEDRIVE%%HOMEPATH%\.local\bin;C:\hostedtoolcache\windows\Python\3.7.9\x64\Scripts;C:\hostedtoolcache\windows\Python\3.7.9\x64;C:\Program Files\Git\bin;C:\msys64\usr\bin;%PATH%
